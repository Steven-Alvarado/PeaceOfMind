...
const TherapistSection: React.FC<TherapistSectionProps> = ({ user }) => {
  ...
  return (
      <div className="bg-blue-100 border-2 border-[#5E9ED9] rounded-lg shadow-lg px-3 py-12 flex flex-col h-full relative">
        {/* Alerts Section */}
        <div className="absolute opacity-40 top-0 left-0 right-0 justify-center">
          {sentAlert && (
        ...
        <div className="flex items-center justify-center mb-6">
          <div className="absolute opacity-60 top-0 left-0 right-0 justify-center">
            {sentAlert && (
              <Alert severity="info" onClose={handleAlert}>
                Your request has been sent.
              </Alert>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col justify-center space-y-6 h-full">
            {therapistDetails ? (
              ...
              <div className="flex flex-col justify-center items-center text-center px-10 py-32 bg-blue-50 rounded-lg shadow-md h-full w-[210%]">
                <div>
                  <h2 className="text-2xl md:text-3xl font-semibold text-gray-800">
