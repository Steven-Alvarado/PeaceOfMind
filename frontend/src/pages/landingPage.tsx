...
import { FaStar, FaEnvelope, FaPhoneAlt, FaFacebook, FaTwitter, FaLinkedin } from 'react-icons/fa';
...
function IntroSection() {
  return (
    <section className="relative flex flex-col items-center overflow-hidden" style={{ minHeight: "90vh" }}>
      ...
      <div className="relative z-0 text-center flex flex-col items-center">
        <h1 className="text-7xl font-extrabold text-[#5E9ED9] mt-44">Peace of Mind</h1>
        ...
        <div className="w-48 h-48 my-4">
          ...
          <h2 className="text-3xl text-[#5E9ED9] p-2 font-semibold">
            <Typewriter
              words={['A Place to Find Your Calm', 'Your Journey to Peace Starts Here', 'Discover Tranquility']}
              loop={true}
              cursor
              cursorStyle="_"
              typeSpeed={70}
    ...
    >
      ...
      <div className="container mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center justify-center z-40">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <div className="rounded-full overflow-hidden bg-white p-4 shadow-lg" style={{ width: '400px', height: '400px' }}>
            <Lottie animationData={AboutAnimation} loop={true} style={{ height: '100%', width: '100%' }} />
          </div>
        </motion.div>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-4xl font-bold mb-4 text-center text-[#5E9ED9]">About Us</h2>
          <p className="text-lg text-gray-700 mb-6">
            We are dedicated to providing affordable therapy services tailored for college students. 
            With a focus on reducing stress and improving mental well-being, we offer licensed therapists 
            that students can talk to at their convenience.
          </p>
          <div className="space-y-4">
            <div className="flex items-start hover:scale-105 transition-transform">
              <span className="text-blue-500 mr-3">💬</span>
              <p className="text-gray-700">
                <span className="font-semibold">Therapy Services:</span> Access licensed therapists anytime.
              </p>
            </div>
            <div className="flex items-start hover:scale-105 transition-transform">
              <span className="text-blue-500 mr-3">📓</span>
              <p className="text-gray-700">
                <span className="font-semibold">Journaling:</span> Reflect on your thoughts and emotions daily.
              </p>
            </div>
            <div className="flex items-start hover:scale-105 transition-transform">
              <span className="text-blue-500 mr-3">📊</span>
              <p className="text-gray-700">
                <span className="font-semibold">Analytics:</span> Track your mental health progress over time.
              </p>
            </div>
            <div className="flex items-start hover:scale-105 transition-transform">
              <span className="text-blue-500 mr-3">📅</span>
              <p className="text-gray-700">
                <span className="font-semibold">Daily Surveys:</span> Answer short surveys to help you stay in tune with your well-being.
              </p>
            </div>
          </div>
          ...
          <p className="mt-6 italic text-gray-500">
            "Peace of Mind has helped me stay grounded and manage my stress through college. Highly recommended!"
          </p>
        </motion.div>
      </div>
    </section>
  ...
  const adviceData = [
    {
      ...
      animation: Advice1,
      description: [
        { emoji: "📅", text: "Create a weekly planner to track assignments and deadlines." },
        { emoji: "✅", text: "Set small, achievable goals to keep yourself motivated." }
      ],    
    },
    {
      id: 2,
      ...
      animation: Advice2,
      description: [
        { emoji: "🛌", text: "Ensure you get enough rest; a well-rested mind is more productive." },
        { emoji: "💆", text: "Take short breaks to relax and recharge during study sessions." }
      ],
    },
    {
      id: 3,
      ...
      animation: Advice3,
      description: [
        { emoji: "🎯", text: "Break down long-term goals into smaller, manageable tasks." },
        { emoji: "📝", text: "Review and adjust your goals periodically to stay on track." }
      ],
    },
  ];

  return (
    <section id="advice" className="relative flex items-center justify-center py-16 bg-white overflow-hidden">
      ...
      <div className="z-40">
        <h2 className="text-4xl font-bold text-center mb-12 text-[#5E9ED9]">Advice</h2>  
            ...
            >
              <div className="bg-[#5E9ED9] rounded-3xl bg-opacity-20 mr-6">
                <div className="w-40 h-40 md:w-48 md:h-48 flex-shrink-0 rounded-md overflow-hidden ">
                  <Lottie animationData={advice.animation} loop={true} style={{ width: '100%', height: '100%' }} />
                </div>
              </div>

              <div className="w-full">
                <h3 className="text-2xl font-semibold text-[#5E9ED9] mb-2">{advice.title}</h3>
  ...
  const faqData: FAQ[] = [
    {
      ...
      answer: "Peace of Mind is a mental health platform designed for college students, offering affordable access to licensed therapists, daily journaling, progress tracking, and self-care resources."
    },
    {
      id: 2,
      question: "How can I access therapy sessions?",
      answer: "You can schedule therapy sessions through our platform. After signing up, you’ll have access to a network of licensed therapists ready to help you at your convenience."
    },
    {
      id: 3,
      question: "Is Peace of Mind affordable for students?",
      answer: "Yes, Peace of Mind was created with students in mind, offering cost-effective therapy options and free resources to help manage stress and mental well-being."
    },
    {
      id: 4,
      question: "How does journaling help with mental health?",
      answer: "Journaling helps you process thoughts and emotions, track your mental health progress, and understand your stress patterns. Our platform provides prompts and reminders to make it easy to start."
    },
    {
      id: 5,
      question: "Can I track my mental health progress?",
      answer: "Yes, Peace of Mind includes an analytics tool that tracks your daily check-ins, mood logs, and other self-care activities to help you visualize your mental health journey."
    }
  ];
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6 md:px-12 z-40">
        <h2 className="text-4xl font-bold text-center mb-12 text-[#5E9ED9]">FAQ</h2>
        <div className="space-y-4">
  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        viewport={{ once: true }}
      >
        <h2 className="text-4xl font-bold text-center mb-12 text-[#5E9ED9]">Reviews</h2>
        <Slider {...settings} className="p-8 bg-[#5E9ED9] rounded-xl">
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-[#5E9ED9]">{review.name}</h3>
...
function ContactSection() {
  return (
    <section id="contact" className="py-16 bg-blue-100 flex flex-col items-center justify-center text-center relative overflow-hidden">
      ...
      >
        <div className="flex items-center space-x-4">
          ...
          <span className="text-gray-700 font-medium text-lg">peaceofmind@therapy.com</span>
        </div>
        <div className="flex items-center space-x-4">
          <FaPhoneAlt className="text-[#5E9ED9] text-2xl" />
          <span className="text-gray-700 font-medium text-lg">1-800-PeaceOfMind</span>
        </div>
      </motion.div>
      <motion.div 
