...
async function testPatientRequestTherapist() {
  ...
  try {
    ...
    const findTherButton = await therDetails.findElement(
      By.xpath("//button[.//span[contains(text(), 'Find Therapist')]]")
    );
    await findTherButton.click();
