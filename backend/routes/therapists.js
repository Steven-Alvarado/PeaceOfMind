...
router.put("/toggleAvailability/:id", toggleAvailability); // Toggle availability by therapist idrouter.put('/:id/availability', updateAvailability); // Update therapist availability
